...
class PathFollowingPlanner:
    def __init__(self, robot_interface: RobotInterface, planning_params: dict, obstacle: Obstacle):
        self.robot_interface = robot_interface
    ...
    def get_list_of_best_q(self) -> np.ndarray:
        ...
        for waypoint in self.waypoints:
            ik_sols = np.asarray(self.robot_interface.ik(waypoint.homogeneous()))
